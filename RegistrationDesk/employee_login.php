      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="254px" height="54px"><span class="splash-description">Patient Registration Department Login Panel</span></div>
            <div class="card-body">
