...
<head>
  ...
  <title>MediLink Information System </title>
...
<body>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <link rel="shortcut icon" href="assets/img/logo-fave.png">
    <h5 class="my-0 mr-md-auto font-weight-normal">MediLink</h5>
  </div>

  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">MediLink Information System Modules</h1>
  ...
  <div class="container">
    ...
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-4 shadow-sm">
        <div class="card-header">
          <h4 class="my-0 font-weight-normal">Doctor</h4>
        </div>
        <div class="card-body">
          <h1 class="card-title pricing-card-title"></h1>
          <a href="Doctor/employee_login.php" class="btn btn-lg btn-block btn-outline-primary">Login</a>
        </div>
      </div>
