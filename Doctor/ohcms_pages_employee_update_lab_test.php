...
<body>
          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Patient Diagnosis</li>
              </ol>
            </nav>
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Patient Details<span class="card-subtitle">Please fill required details.</span></div>
              <div class="card-body">
                <?php if (isset($msg)) { ?>
                  <script>
                    setTimeout(function() {
  ...
  <div class="form-group row">
    ...
    <div class="col-12 col-sm-8 col-lg-6">
      <input class="form-control" id="inputText3" value="<?php echo $row->p_fname; ?>" name="p_fname" type="text" readonly>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Last Name</label>
    <div class="col-12 col-sm-8 col-lg-6">
      <input class="form-control" id="inputText3" value="<?php echo $row->p_lname; ?>" name="p_lname" type="text" readonly>
    </div>
  </div>

  <div class="form-group row">
    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Diagnosis</label>
    <div class="col-12 col-sm-8 col-lg-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-12 col-sm-8 col-lg-6">
      <textarea class="form-control" id="editor1" readonly name="p_lab_tests" type="text"></textarea>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Laboratory Results</label>
    <div class="col-12 col-sm-8 col-lg-6">
      <textarea class="form-control" id="editor2" readonly name="p_lab_results" type="text"></textarea>
    </div>
  </div>
