                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="parent active"><a href="#"><i class="icon mdi mdi-wheelchair-accessibility"></i><span>OutPatient</span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="ohcms_pages_employee_search_outpatient_records.php">Advanced Search</a>
                      </li>
                    </ul>
                  </li>
                  <li class="parent active"><a href="#"><i class="icon mdi mdi-hotel"></i><span>InPatient</span></a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="ohcms_pages_employee_advance_search_inpatients.php">Advanced Search</a>
                      </li>
                    </ul>
                  </li>
                  <li class="parent active"><a href="#"><i class="icon mdi mdi-flask"></i><span>Patient Diagnosis</span></a>
                    <ul class="sub-menu">
                      <li><a href="ohcms_pages_employee_add_patient_lab_diag.php">Patient Appointments</a>
                      </li>
                      </li>
                    </ul>
                  </li>
